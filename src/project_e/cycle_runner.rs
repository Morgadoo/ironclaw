...
impl CognitiveCycleRunner {
    ...
    pub fn new(
        ...
        let self_model_builder =
            SelfModelBuilder::new(meta_config.recovery_threshold, meta_config.cautious_threshold);
    ...
    async fn run_cycle(&mut self) -> Result<CycleResult, String> {
        ...
        let action_plan = self.deliberation.deliberate(cycle_id, filtered_gaps, &self_model);
